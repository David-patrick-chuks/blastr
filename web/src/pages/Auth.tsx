                ...
                <div className="border border-zinc-800 bg-zinc-900/50 backdrop-blur p-8 relative">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <button className="flex items-center justify-center gap-2 border border-zinc-800 bg-zinc-950 py-3 hover:bg-zinc-900 transition-colors">
                                ...
                                <span className="text-sm font-mono tracking-widest">CONTINUE WITH GOOGLE</span>
                            </button>
                        </div>
                    </div>
